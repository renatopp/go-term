// Package cell provides terminal-cell parsing and serialization shared by
// term (frame diffing) and term/ui (container compositing). It is internal
// because it's an implementation detail of both, not part of either's
// public API.
package cell
